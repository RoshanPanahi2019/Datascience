...
def my_read_file(path):
    ...
    data=data.drop(columns="Scope of Work")
...
def my_one_hot_encode(data, column_name): # One-Hot-Encoding the label
    ...
    data.to_csv("/media/ms/D/myGithub_Classified/Skanska/Data_Source/Out/Merge_Tbl_1_3_Freq_Reduced_Amount_Reduced_Budget_Label_OneHotEncoded.csv", index=False )
    return data
...
if __name__=="__main__":
    ...
    path="/media/ms/D/myGithub_Classified/Skanska/Data_Source/Merge_Tbl_3_4_Freq_Reduced_DelayAmount_Reduced_Budget_Label.csv"
